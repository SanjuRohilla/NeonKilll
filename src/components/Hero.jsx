...
const Hero = () => {
    ...
    useGSAP(()=>{
       gsap.set('#video-frame',{
           clipPath: 'polygon(14% 0%,72% 0%,85% 85%,0% 100%)',
        ...
        <div className="relative h-dvh w-screen overflow-x-hidden">
            ...
            <div id="video-frame" className="relative z-10 h-dvh w-screen overflow-hidden rounded-lg bg-blue-75">
              <div>
                ...
                absolute-center absolute z-50 size-64 cursor-pointer overflow-hidden rounded-lg'>
               ...
               <div className='absolute left-0 top-0 z-40 size-full '>
                 <div className='mt-24 px-5 sm:px-10 '>
                     ...
                     <Button id='watch-trailer' title='Watch Trailer' leftIcon={<TiLocationArrow/>} containerClass=
